<template>
  <div class="page-container">
    <div class="page-header">
      <el-button type="success" icon="el-icon-plus" @click="handleAdd">提交报修</el-button>
    </div>
    ...
    <el-dialog title="提交报修" :visible.sync="dialogVisible" width="500px">
      <el-form ref="addForm" :model="addForm" :rules="formRules" label-width="60px">
        <el-form-item label="标题" prop="title">
          <el-input v-model="addForm.title" placeholder="请简要描述维修问题" />
        </el-form-item>
        <el-form-item label="内容" prop="content">
          <el-input v-model="addForm.content" type="textarea" :rows="5" placeholder="请详细描述维修内容" />
        </el-form-item>
      </el-form>
      <div slot="footer">
...
export default {
  ...
  methods: {
    ...
    async loadData() {
      const res = await repairApi.my(this.query)
    ...
    async submitForm() {
      this.$refs.addForm.validate(async valid => {
        if (!valid) return
        await repairApi.add(this.addForm)
